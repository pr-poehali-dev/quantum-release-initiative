            ...
            <div className="space-y-4 md:space-y-8">
              ...
              >
                <div className="mb-1 flex items-center gap-2">
                  ...
                  <span className="font-mono text-xs text-foreground/60">Зона покрытия</span>
                </div>
                <p className="text-base text-foreground md:text-2xl">Ваш город</p>
              </div>
          ...
          <div className="flex flex-col justify-center">
            <form onSubmit={handleSubmit} className="space-y-4 md:space-y-6">
              ...
              <div
                ...
                style={{ transitionDelay: "500ms" }}
              >
                <label className="mb-1 block font-mono text-xs text-foreground/60 md:mb-2">Адрес подключения</label>
                <textarea
                  rows={3}
              ...
              >
                ...
                {submitSuccess && (
                  <p className="mt-3 text-center font-mono text-sm text-foreground/80">Заявка принята! Перезвоним в течение 30 минут.</p>
                )}
              </div>
            </form>
          </div>
